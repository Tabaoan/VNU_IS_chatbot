...
PINECONEINDEX_NAME = os.getenv("PINECONE_INDEX_NAME", "excel-index")

EXCEL_FOLDER = r"C:\Users\tabao\OneDrive\Desktop\NLP\VNU_IS Chatbot"
EMBEDDING_DIM = 3072
BATCH_SIZE = 50
...
def get_excel_files(folder_path: str) -> List[str]:
    """Lấy danh sách file Excel và CSV trong folder"""
...
def load_and_chunk_excel(file_path: str) -> List[Document]:
    """Đọc file Excel/CSV và chia nhỏ nội dung"""
...
if __name__ == "__main__":
    ...
    if not excel_files:
        print(f"❌ Không tìm thấy file xlsx/xls/csv nào trong thư mục: {EXCEL_FOLDER}")
        exit(1)

    print(f"📊 Tìm thấy {len(excel_files)} file dữ liệu:")
    ...
    print("\n🎉 Hoàn thành ingest CSV + Excel vào Pinecone!")
